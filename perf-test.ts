...
async function runPerformanceTests() {
	...
	console.log(
		`  ✓ Throughput: ${Math.round(surfaceResult.opsPerSec)} calls/sec\n`,
	);
	...
	console.log(
		`  ✓ Throughput: ${Math.round(deepResult.opsPerSec)} calls/sec\n`,
	);
	...
	console.log(
		`  ✓ Throughput: ${Math.round(synthResult.opsPerSec)} calls/sec\n`,
	);
	...
	console.log(
		`  ✓ Throughput: ${Math.round(agentResult.opsPerSec)} calls/sec\n`,
	);
	...
	for (const a of assertions) {
		...
		console.log(
			`  ${passed ? "✅" : "❌"} ${a.name}: ${formatTime(a.result.avgTime)} < ${a.maxMs}ms`,
		);
